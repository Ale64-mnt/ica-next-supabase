          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-8">
              ...
              <div className="text-center bg-gray-50 rounded-lg p-6">
                ...
                {/* Link esplicito sotto la bio - CON TRADUZIONE */}
                <div className="mt-4">
                  <Link 
              ...
              <div className="text-center bg-gray-50 rounded-lg p-6">
                {/* Nome NON cliccabile */}
                <h3 className="text-xl font-semibold mb-2 text-gray-900">
                  {t('founders.Egle.name')}
                </h3>
                <p className="text-blue-600 font-medium mb-3">{t('founders.Egle.role')}</p>
                <p className="text-gray-600 text-sm leading-relaxed mb-4">{t('founders.Egle.bio')}</p>
                
                {/* Link esplicito sotto la bio - CON TRADUZIONE */}
                <div className="mt-4">
                  <Link 
                    href={`/${locale}/about/bio/egle-mantovani`}  // 🔥 Cambiato lo slug
                    className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium text-sm"
                  >
                    <span>{t('readFullBio')}</span>  {/* 🔥 Stessa chiave di traduzione */}
                    <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                    </svg>
                  </Link>
